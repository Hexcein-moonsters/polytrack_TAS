...
$jscomp.scope = {},
    ...
    $jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function (t, e, r) {
...
$jscomp.polyfill = function (t, e, r, n) {
    ...
    $jscomp.polyfillIsolated = function (t, e, r, n) {
        ...
        o = o[o.length - 1],
            null != (e = e(r = $jscomp.IS_SYMBOL_NATIVE && "es6" === r ? n[o] : null)) && (t ? $jscomp.defineProperty($jscomp.polyfills, o, {
                configurable: !0,
                writable: !0,
                value: e
            }) : e !== r && (void 0 === $jscomp.propertyToPolyfillSymbol[o] && (r = 1e9 * Math.random() >>> 0,
                $jscomp.propertyToPolyfillSymbol[o] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(o) : $jscomp.POLYFILL_PREFIX + r + "$" + o),
    ...
    $jscomp.polyfill("Promise", (function (t) {
        ...
        if (t && (!($jscomp.FORCE_POLYFILL_PROMISE || $jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION && void 0 === $jscomp.global.PromiseRejectionEvent) || !$jscomp.global.Promise || -1 === $jscomp.global.Promise.toString().indexOf("[native code]")))
            return t;
        ...
        o.prototype.createResolveAndReject_ = function () {
            ...
            o.prototype.notifyUnhandledRejection_ = function () {
                ...
                return void 0 === r || ("function" == typeof t ? t = new t("unhandledrejection", {
                    ...
                    cancelable: !0
                }) : (t = $jscomp.global.document.createEvent("CustomEvent")).initCustomEvent("unhandledrejection", !1, !0, t),
                    t.promise = this,
        ...
        return o.prototype.settleSameAsPromise_ = function (t) {
            ...
            o.prototype.then = function (t, e) {
                ...
                return this.callWhenSettled_(r(t, n), r(e, _)),
                    i
            }
            ,
    ...
    $jscomp.polyfill("Array.prototype.copyWithin", (function (t) {
        function e(t) {
        ...
        return t || function (t, r, n) {
            ...
            if (t = e(t),
                ...
                t < r)
                for (; r < n;)
                    r in this ? this[t++] = this[r++] : (delete this[t++],
                        r++);
            else
    ...
    return "undefined" != typeof __filename && (t = t || __filename),
        function (e) {
            function r(t, e, r) {
                ...
                for (r = e; t[r] && !(r >= n);)
                    ++r;
                if (16 < r - e && t.buffer && it)
                    return it.decode(t.subarray(e, r));
                for (n = ""; e < r;) {
                    var o = t[e++];
                    if (128 & o) {
                        var _ = 63 & t[e++];
                        if (192 == (224 & o))
                            ...
                            var i = 63 & t[e++];
                            65536 > (o = 224 == (240 & o) ? (15 & o) << 12 | _ << 6 | i : (7 & o) << 18 | _ << 12 | i << 6 | 63 & t[e++]) ? n += String.fromCharCode(o) : (o -= 65536,
            ...
            function c() {
                ...
                if (!(0 < ut)) {
                    ...
                    p(pt),
                        0 < ut || (C.setStatus ? (C.setStatus("Running..."),
                            setTimeout((function () {
                                setTimeout((function () {
                                    C.setStatus("")
                                }
            ...
            function y(t, e) {
                var r = u(e)
                    , n = r[t];
                return n || ((n = Object.create((e || s).prototype)).ptr = t,
                    r[t] = n)
            }
            function l(t) {
                if ("string" == typeof t) {
                    for (var e = 0, r = 0; r < t.length; ++r) {
                        ...
                        127 >= n ? e++ : 2047 >= n ? e += 2 : 55296 <= n && 57343 >= n ? (e += 4,
                            ++r) : e += 3
                    }
                    if (r = 0,
                        0 < (n = (e = Array(e + 1)).length)) {
                        n = r + n - 1;
            ...
            C.onRuntimeInitialized = function () {
                $ = !0,
                    w && "function" == typeof C.onModuleLoaded && C.onModuleLoaded(C)
            }
                ,
                C.onModuleParsed = function () {
                    w = !0,
                        $ && "function" == typeof C.onModuleLoaded && C.onModuleLoaded(C)
                }
                ,
            ...
            if (W) {
                ...
                var Y = function (t, e) {
                    return t = t.startsWith("file://") ? new URL(t) : Q.normalize(t),
                        x.readFileSync(t, e ? void 0 : "utf8")
                }
                    , H = function (t) {
                        return (t = Y(t, !0)).buffer || (t = new Uint8Array(t)),
                            t
                    }
                    , q = function (t, e, r) {
                ...
                (V || B) && (B ? k = self.location.href : "undefined" != typeof document && document.currentScript && (k = document.currentScript.src),
                    t && (k = t),
            ...
            var X, K = C.print || console.log.bind(console), J = C.printErr || console.warn.bind(console);
            Object.assign(C, z),
                z = null,
                C.wasmBinary && (X = C.wasmBinary),
                "object" != typeof WebAssembly && _("no native wasm support detected");
            var Z, tt, et, rt, nt, ot, _t = !1, it = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0, pt = [], at = [], ct = [], st = !1, ut = 0, yt = null, lt = null, ft = "draco_decoder.wasm";
            ft.startsWith("data:application/octet-stream;base64,") || (ot = ft,
                ft = C.locateFile ? C.locateFile(ot, k) : k + ot);
            var mt = [null, [], []]
                , dt = {
                    b: function (t, e, r) {
                        throw new a(t).init(e, r),
                        t
                    },
                    a: function () {
                        _("")
                    ...
                    e: function (t) {
                        ...
                        for (var r = 1; 4 >= r; r *= 2) {
                            ...
                            t: {
                                n = Z.buffer;
                                try {
                                    Z.grow(_ - n.byteLength + 65535 >>> 16),
                                        o();
                                    var i = 1;
                                    break t
                                } catch (t) { }
            ...
            !function () {
                ...
                if (ut++,
                    ...
                    try {
                        ...
                        J("Module.instantiateWasm callback failed with error: " + t),
                            L(t)
                    }
                (X || "function" != typeof WebAssembly.instantiateStreaming || ft.startsWith("data:application/octet-stream;base64,") || ft.startsWith("file://") || W || "function" != typeof fetch ? r(e) : fetch(ft, {
                    ...
                    return WebAssembly.instantiateStreaming(t, n).then(e, (function (t) {
                        return J("wasm streaming compile failed: " + t),
            ...
            var tn = {
                ...
                prepare: function () {
                    if (tn.needed) {
                        for (var t = 0; t < tn.temps.length; t++)
                            C._free(tn.temps[t]);
                        tn.temps.length = 0,
                            C._free(tn.buffer),
                            tn.buffer = 0,
                    ...
                    tn.buffer || (tn.size += 128,
                        tn.buffer = C._malloc(tn.size),
                        tn.buffer || _(void 0)),
                        tn.pos = 0
                },
                alloc: function (t, e) {
                    return tn.buffer || _(void 0),
                        t = (t = t.length * e.BYTES_PER_ELEMENT) + 7 & -8,
                        tn.pos + t >= tn.size ? (0 < t || _(void 0),
                            tn.needed += t,
                            e = C._malloc(t),
                            tn.temps.push(e)) : (e = tn.buffer + tn.pos,
                                tn.pos += t),
                        e
                },
                copy: function (t, e, r) {
            ...
            return m.prototype = Object.create(s.prototype),
                ...
                d.__cache__ = {},
                C.DecoderBuffer = d,
                d.prototype.Init = d.prototype.Init = function (t, e) {
                    var r = this.ptr;
                    tn.prepare(),
                ...
                b.prototype.transform_type = b.prototype.transform_type = function () {
                    return It(this.ptr)
                }
                ,
                ...
                T.prototype.InitFromAttribute = T.prototype.InitFromAttribute = function (t) {
                    var e = this.ptr;
                    return t && "object" == typeof t && (t = t.ptr),
                        !!$t(e, t)
                }
                ,
                ...
                D.prototype.InitFromAttribute = D.prototype.InitFromAttribute = function (t) {
                    var e = this.ptr;
                    return t && "object" == typeof t && (t = t.ptr),
                        !!kt(e, t)
                }
                ...
                j.__cache__ = {},
                C.Mesh = j,
                j.prototype.num_faces = j.prototype.num_faces = function () {
                    return Jt(this.ptr)
                }
                ,
                ...
                G.__cache__ = {},
                C.Status = G,
                G.prototype.code = G.prototype.code = function () {
                    return oe(this.ptr)
                }
                ,
                ...
                v.prototype.GetValue = v.prototype.GetValue = function (t) {
                    var e = this.ptr;
                    return t && "object" == typeof t && (t = t.ptr),
                        ce(e, t)
                }
                ...
                P.__cache__ = {},
                C.DracoUInt8Array = P,
                P.prototype.GetValue = P.prototype.GetValue = function (t) {
                    var e = this.ptr;
                    return t && "object" == typeof t && (t = t.ptr),
                        be(e, t)
                }
                ...
                R.__cache__ = {},
                C.DracoInt16Array = R,
                R.prototype.GetValue = R.prototype.GetValue = function (t) {
                    var e = this.ptr;
                    return t && "object" == typeof t && (t = t.ptr),
                        De(e, t)
                }
                ...
                S.prototype.GetValue = S.prototype.GetValue = function (t) {
                    var e = this.ptr;
                    return t && "object" == typeof t && (t = t.ptr),
                        Ge(e, t)
                }
                ...
                M.__cache__ = {},
                C.DracoInt32Array = M,
                M.prototype.GetValue = M.prototype.GetValue = function (t) {
                    var e = this.ptr;
                    return t && "object" == typeof t && (t = t.ptr),
                        Re(e, t)
                }
                ...
                N.prototype.GetValue = N.prototype.GetValue = function (t) {
                    var e = this.ptr;
                    return t && "object" == typeof t && (t = t.ptr),
                        Ue(e, t)
                }
                ...
                U.__cache__ = {},
                C.MetadataQuerier = U,
                U.prototype.HasEntry = U.prototype.HasEntry = function (t, e) {
                    var r = this.ptr;
                    return tn.prepare(),
                ...
                g.__cache__ = {},
                C.Decoder = g,
                g.prototype.DecodeArrayToPointCloud = g.prototype.DecodeArrayToPointCloud = function (t, e, r) {
                    var n = this.ptr;
                    return tn.prepare(),
                        "object" == typeof t && (t = f(t)),
                        e && "object" == typeof e && (e = e.ptr),
